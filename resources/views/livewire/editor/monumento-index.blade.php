<div class="container py-8">
    ...
    <x-table-responsive>
        ...
        <p class="text-gray-600 text-xl text-center">MONUMENTOS DE SANTIAGO</p>
         ...
         <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
             ...
             <div class="px-6 py-4 flex">
                 ...
                 <a class="btn btn-danger ml-2" href="{{route('editor.catedrals.create')}}">Crear nuevo elemento</a>
             </div>
             @if($elementos->count())
