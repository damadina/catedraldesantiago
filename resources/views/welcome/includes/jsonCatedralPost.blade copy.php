...
<script type="application/ld+json">
    {
        ...
        "@type": "WebPage",
        "name": "{{$elemento->name}}",
        "url": "https://catedraldesantiago.online/{{$elemento->slug}}",
        ...
        "isPartOf":
        {
            ...
            "publisher": {
                ...
                "sameAs": [
                    "https://www.facebook.com/mascompostela/",
                    "https://twitter.com/catedraldesant2",
                    "https://www.youtube.com/@catedraldesantiagodecompostela"
                ],
                "logo": {
                    "@type": "ImageObject",
        ...
        "mainEntity":{
            "@type": "Article",
            "abstract": "{{ strip_tags($elemento->resumen)}}",
            "image": "https://catedraldesantiago.online/storage/portadascard/{{$elemento->urlPortada}}",
            "wordCount": "{{$palabrasArticulo}}",
            "headline": "Toda la historia de {{strip_tags($elemento->name)}}",
            "articleBody": "{{$todoelArticulo}}",
            "author": {
                "@type": "Organization",
                "name": "catedraldesantiago.online",
                "url": "https://catedraldesantiago.online/autores"
            }
        }
