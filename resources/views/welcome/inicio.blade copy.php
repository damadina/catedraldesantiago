<x-app-layout>
   ...
   {{--  @slot('overMenu')
        <div class="bg-catedral mb-2">
            <p class="text-white font-bold py-2 text-center text-xl">Catedral de Santiago de Compostela</p>
        </div>
    @endslot --}}
    <header>
        {{-- <div class="h-screen/2" style="background-image: url({{asset('storage/portadas' . '/' . $elemento->urlPortada)}}); background-size: cover; background-position: center;">
            <h1 class="pt-10 text-center text-white uppercase textShadow3 font-semibold text-base sm:text-xl  md:text-4xl lg:text-5xl tracking-[.15em]  italic">
                {{ $elemento->name }}
            </h1>
        </div>
        ...
        <div class="container">
            ...
            {{-- <div>
                <img  class="h-screen/2 w-full object-cover object-bottom" alt="Font Mirabilis" src="/storage/fotos/39/original/Catedral_4019_lMXM9gXhA6.jpg" loading="lazy" >
            </div> --}}

            <figure class="relative ">
                <img class="h-screen/2 w-full object-cover object-center"  src="{{'/storage/portadas' . '/' . $elemento->urlPortada}}" loading="lazy">
            ...
            <div class=" border-l-8 ml-4 pl-4 border-catedral indent-8 text-gray-600 italic text-lg mt-6 sm:text-xl tracking-wide">
                {!! $elemento->resumen !!}
            </div>
    </header>
    ...
    <h2 class="text-center mt-4 text-base md:text-2xl font-semibold underline text-catedral">HISTORIA DE LA CATEDRAL DE SANTIAGO</h2>

    <figure class="container  mt-4 w-max ">
        <img alt="Catedral de Santiago de Compostela" class="w-max" src="/storage/fotos/2/original/XulioGil_0011_gvrmzAPeXB.jpg" loading="lazy">
        <figcaption class="bg-gray-100 text-center pb-2 italic text-gray-600">
        <span>Catedral de Santiago de Compostela</span>
        </figcaption>
    </figure>
    <div id="historia" class="container mb-24 mt-8">
        @foreach ($reports as $item)
                ...
                <h3 class="mt-4 text-base md:text-2xl font-semibold underline text-catedral">{{$item->titulo}}</h3>
