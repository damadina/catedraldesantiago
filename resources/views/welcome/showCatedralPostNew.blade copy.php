    ...
    <article>
            ...
            <header>
                ...
                <div class="relative">
                    ...
                    <div class="container  absolute  left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">

                        <h1 class=" text-center text-white uppercase textShadow3 font-semibold text-base sm:text-xl  md:text-4xl lg:text-5xl tracking-[.15em]  italic">
                            {{ $elemento->name }}
                        </h1>
            ...
            <p class="text-center text-2xl text-catedral font-semibold">TODA LA HISTORIA {{ strtoupper($elemento->prefijoH1) }} {{ strtoupper($elemento->name) }} </p>
