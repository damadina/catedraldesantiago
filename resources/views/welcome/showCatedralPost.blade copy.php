    ...
    @endphp
        ...
        <main>
            <header>
                ...
                {{-- <img src="{{ asset('storage/portadas') . '/' . $elemento->urlPortada }}" class=" w-full object-cover" alt=""> --}}
                    <div class="">
                        <div class="absolute top-10 left-1/2 transform -translate-x-1/2">
                            <div class="items-center justify-center hidden md:flex">
                                <img class="text-white mx-auto" src="{{ asset('images/logoB.png') }}" loading="lazy"
                                    alt="Logo Catedradesantiago.online" title="logo Catedraldesantiago.online" width="30"
                                    height="43">
                                <p class=" text-gray-300">catedraldesantiago.online</p>
                            </div>
                        </div>
                            ...
                            <div class="containerA">
                                <div>
                                    <h1 class="pl-10 text-center text-shadow-lg font-semibold text-2xl md:text-6xl tracking-[.15em]  italic">
                                        {{ $elemento->name }}</h1>
                                    <p class="pt-4 text-shadow-lg container text-gray-100 text-center italic  text-xs md:text-xl tracking-[.15em] md:leading-8">
                        ...
                        {{-- <div class="cabecera ">
                            <div class="containerA">
                                <div>
                                    <h1 class="pl-10 text-center  font-semibold text-2xl md:text-6xl tracking-[.15em]  italic">
                                        {{ $elemento->name }}</h1>
                                    <p class="pt-4 container text-gray-100 text-center italic  text-xs md:text-xl tracking-[.15em]  leading-8">
                                        {{ $elemento->seoDescription }}</p>
                                </div>
                            </div>
                        </div> --}}
            ...
            <div class="bg-gray-200 z-50 top-0 sticky">
                <div class="mx-4 grid grid-cols-2 md:grid-cols-6 gap-2   pt-4 pb-4">
