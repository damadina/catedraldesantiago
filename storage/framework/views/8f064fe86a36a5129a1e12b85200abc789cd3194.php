...
} elseif ($_instance->childHasBeenRendered('tEwMbzZ')) {
    $componentId = $_instance->getRenderedChildComponentId('tEwMbzZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('tEwMbzZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tEwMbzZ');
} else {
    $response = \Livewire\Livewire::mount('editor.catedral-index-fotos', ['elemento' => $elemento]);
    $html = $response->html();
    $_instance->logRenderedChild('tEwMbzZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon2\www\catedral\resources\views/editor/catedral/fotos/index.blade.php ENDPATH**/ ?>