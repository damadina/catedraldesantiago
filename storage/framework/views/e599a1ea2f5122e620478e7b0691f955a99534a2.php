...
} elseif ($_instance->childHasBeenRendered('cCJTAXo')) {
    $componentId = $_instance->getRenderedChildComponentId('cCJTAXo');
    $componentTag = $_instance->getRenderedChildComponentTagName('cCJTAXo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cCJTAXo');
} else {
    $response = \Livewire\Livewire::mount('editor.catedral-index-informations', ['elemento' => $elemento]);
    $html = $response->html();
    $_instance->logRenderedChild('cCJTAXo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\catedral\resources\views/editor/catedral/informations/index.blade.php ENDPATH**/ ?>