...
} elseif ($_instance->childHasBeenRendered('TDaLEzx')) {
    $componentId = $_instance->getRenderedChildComponentId('TDaLEzx');
    $componentTag = $_instance->getRenderedChildComponentTagName('TDaLEzx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TDaLEzx');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('TDaLEzx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\catedral\resources\views/layouts/editor.blade.php ENDPATH**/ ?>