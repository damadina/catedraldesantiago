...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mt-3 indent-8 text-base md:text-xl text-black ">
        ...
        <?php echo $horarios[0]->respuesta; ?>

        <div class="text-xs italic my-6">
            <a href="http://catedraldesantiago.es/visitas/#horarios"  target="_blank">Fuente: catedraldesantiago.es</a>
        </div>
    </div>
    <div class="my-auto">
        <div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\catedral\resources\views/welcome/horariosCatedral.blade.php ENDPATH**/ ?>