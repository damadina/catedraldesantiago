...
<?php $component->withAttributes([]); ?>
    <?php $__env->slot('masHead'); ?>
        <title>Misas en la Catedral de Santiago de Compostela</title>

        <meta name="description" content="Horarios de misa en las Capillas interiores de la Catedral de Santiago. ** Descargate el plano de la Catedral **">
        <meta name="keywords" content="Misas en la Catedral de Santiago"/>
    ...
    <h1 class="w-full  mt-4 text-center text-catedral tracking-widest textShadow3 uppercase  font-semibold text-base sm:text-xl  md:text-2xl lg:text-3xl">
        MISAS EN LA CATEDRAL DE SANTIAGO
     </h1>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\catedral\resources\views/welcome/misasCatedral.blade.php ENDPATH**/ ?>