...
} elseif ($_instance->childHasBeenRendered('l3924115063-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3924115063-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3924115063-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3924115063-0');
} else {
    $response = \Livewire\Livewire::mount('search');
    $html = $response->html();
    $_instance->logRenderedChild('l3924115063-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH C:\laragon2\www\catedral\resources\views/navigation-menu.blade.php ENDPATH**/ ?>