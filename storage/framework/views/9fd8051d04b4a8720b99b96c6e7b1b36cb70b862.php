...
} elseif ($_instance->childHasBeenRendered('HEUIlCy')) {
    $componentId = $_instance->getRenderedChildComponentId('HEUIlCy');
    $componentTag = $_instance->getRenderedChildComponentTagName('HEUIlCy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HEUIlCy');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('HEUIlCy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH C:\laragon2\www\catedral\resources\views/layouts/app.blade.php ENDPATH**/ ?>